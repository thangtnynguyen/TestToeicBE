...
namespace Test.Quiz.Api.Data.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20240503034410_EditTableExamResultAnswerDetail")]
    partial class EditTableExamResultAnswerDetail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Test.Quiz.Api.Data.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "be0a3fe8-68fa-4302-9f6e-951124a2cb58",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "64c733bc-c10a-40b6-84d7-5b673d0b89d7",
            ...
            modelBuilder.Entity("Test.Quiz.Api.Data.Entities.ExamToeicResultDetail", b =>
                {
                    b.HasOne("Test.Quiz.Api.Data.Entities.ExamToeicResult", "ExamToeicResult")
                        .WithMany("ExamToeicResultDetails")
                        .HasForeignKey("ExamToeicResultId");

                    b.Navigation("ExamToeicResult");
                });
